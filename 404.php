					...
					<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
						<ul class="navbar-nav m-auto">
							...
							<li class="nav-item">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item">
										...
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a href="our-instructors.html" class="nav-link">Our Instructors</a>
											</li>

											<li class="nav-item">
												<a href="instructors-details.html" class="nav-link">Instructors
													Details</a>
											</li>
										</ul>
									</li>
									...
									<li class="nav-item">
										...
										<ul class="dropdown-menu">
											...
											<li class="nav-item">
												<a href="terms-conditions.html" class="nav-link">Terms And
													Conditions</a>
											</li>
											<li class="nav-item">
											...
											<li class="nav-item">
												<a href="404.html" class="nav-link active">404 Page</a>
											</li>
										</ul>
									</li>
									<li class="nav-item">
							...
							<li class="nav-item">
								...
								<ul class="dropdown-menu">
									<li class="nav-item">
										<a href="our-courses.html" class="nav-link">Our Courses</a>
									</li>
									<li class="nav-item">
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-footer-widget">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
								ut laborelore magna aliqua. Quis ipsum suspendissutrices grada.</p>
						...
						<div class="single-footer-widget">
							...
							<ul class="information-link">
								...
								<li>
									...
									<span>Email Us</span>
									<a
										href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#375f525b5b58775d4251561954585a"><span
											class="__cf_email__"
											data-cfemail="c7afa2ababa887adb2a1a6e9a4a8aa">[email&#160;protected]</span></a>
								</li>
								<li>
