                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item">
                                                <a href="our-instructors" class="nav-link">Our Instructors</a>
                                            </li>

                                            <li class="nav-item">
                                                <a href="instructors-details" class="nav-link">Instructors
                                                    Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="event-details" class="nav-link">Event Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="terms-conditions" class="nav-link">Terms And
                                                    Conditions</a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a href="404" class="nav-link">404 Page</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="our-courses" class="nav-link">Our Courses</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="others-options">
                            <ul class="d-flex justify-content-between align-items-center">
                                <li>
                                    <a href="register" class="sign-in">
                                        <i class="ri-login-box-line"></i>
                                        Sign In
                                    </a>
                                </li>
                                <li>
                                    <a href="our-courses" class="default-btn">
                                        Get Started
